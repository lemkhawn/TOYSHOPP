...
CREATE TABLE `toy` (
  ...
  `toy_image` varchar(40) DEFAULT NULL,
  `toy_price` int(11) DEFAULT NULL,
  `toy_description` text DEFAULT NULL
...
INSERT INTO `toy` (`toy_id`, `toy_name`, `toy_image`, `toy_price`, `toy_description`) VALUES
(1,'Beach Ball', 'sp2.jpg', 123, 'Puzzle'),
...
--
ALTER TABLE `toy`
  MODIFY `toy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
